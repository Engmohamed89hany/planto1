...
export default function Footer() {
    return (
        <footer className="relative overflow-hidden px-6 mt-16 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-200 bg-[#161714] pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium non dignissimos corporis animi quo assumenda quod nostrum id voluptate. Beatae harum dignissimos consequatur sed adipisci impedit sequi quisquam reprehenderit repudiandae?
                    </p>
                </div>
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5 mt-20">
                        <h2 className="font-semibold mb-5 text-gray-100">Planto.</h2>
                        <a className="hover:text-slate-600 transition" href="#">Home</a>
                        <a className="hover:text-slate-600 transition" href="#">About</a>
                        <a className="hover:text-slate-600 transition" href="#">Plantes</a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        ...
                        <div className="flex items-center">
                            <input className="rounded-[20px] bg-[rgba(255,255,255,0.1)] outline-none w-full  h-11 px-3 mr-1.5" type="email" placeholder="Enter your email" />
                            <Btn text="Subscribe" />
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
                <p className="text-center">
                    Copyright 2025 © Planto All Right Reserved.
                </p>
